...
analysis.plot_corner('sf_pess.pdf', MCMC_sf_pess, LSE_sf_con, Beane_sf_con, params_sf, spectra_sf[1][0], k_indices)
...
np.savez('pl_results', data_pl_op=data_pl_op, data_pl_con=data_pl_con, data_pl_pess=data_pl_pess,
                     ...
                     MCMC_pl_op=MCMC_pl_op, MCMC_pl_con=MCMC_sf_con, MCMC_pl_pess=MCMC_pl_pess)
...
np.savez('bt_results', data_bt_op=data_bt_op, data_bt_con=data_bt_con, data_bt_pess=data_bt_pess,
                     ...
                     MCMC_bt_op=MCMC_bt_op, MCMC_bt_con=MCMC_sf_con, MCMC_bt_pess=MCMC_bt_pess)
